...
Read the [JWT Overview](/docs/v2.9/authorization/jwt-overview/) for an introduction to token-based authorization in Velonetics. When working with tokens, there are different things you can do:
...
- [JWT Validation](/docs/v2.9/authorization/jwt-validation/): This is the core functionality, where a user sends a token generated by an Identity Provider, and Velonetics checks for its validity and any required permissions to access the resource.
