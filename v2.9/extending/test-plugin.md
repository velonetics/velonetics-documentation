...
When you upgrade Velonetics to another version you must recompile your plugins using the [builder matching the version](/docs/v2.9/extending/writing-plugins/#plugin-builder).
{{< /note >}}
