...
## PGP
We will check the detached signature [PGP]({{< product download_repo >}}/bin/velonetics_1.3.0_amd64.tar.gz.asc) against our package [Velonetics]({{< product download_repo >}}/bin/velonetics_1.3.0_amd64.tar.gz).

    $ gpg --verify velonetics_1.3.0_amd64.tar.gz.asc velonetics_1.3.0_amd64.tar.gz
...
To make sure the binary downloaded matches our SHA256 ensure the next 2 commands produce the same [SHA]({{< product download_repo >}}/bin/velonetics_1.3.0_amd64.tar.gz.sha256) output.

    ## Your downloaded file
	$ shasum -a 256 -b velonetics_1.3.0_amd64.tar.gz
    ## Our SHA256
    $ curl {{< product download_repo >}}/bin/velonetics_1.3.0_amd64.tar.gz.sha256
