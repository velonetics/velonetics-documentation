...
If you use [flexible-configuration](/docs/v1.3/configuration/flexible-config/) you might want to add a previous generation of the velonetics.json file using a multi-step Docker.
