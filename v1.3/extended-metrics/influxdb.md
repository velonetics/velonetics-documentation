...
Velonetics can expose detailed and extended metrics via the [velonetics-metrics](/docs/v1.3/extended-metrics/influxdb/)). The **velonetics-influx** component lets you **send these extended Velonetics metrics to InfluxDB**.
...
The **native implementation** exports data from a collector that is tailor-made for Velonetics, and also richer in content and less abstract. On the other hand, the [OpenCensus exporter for InfluxDB](/docs/v1.3/telemetry/influxdb/) is more generalistic and abstract, but implements a collector with less data. For our Grafana dahsboard, choose this one.
{{< /note >}}
