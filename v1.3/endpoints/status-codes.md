...
To offer a gracefully degraded service when some backends fail, we leave the decision to the client on what to do by adding the header `X-Velonetics-Completed: false` (some backends succeeded, others don't) and also by adding the [detailed errors](/docs/v1.3/backends/detailed-errors/) feature.
...
- **Injecting your own [HTTPStatusHandler](https://github.com/velonetics/velonetics-ce/issues/102#issuecomment-373657911)**
