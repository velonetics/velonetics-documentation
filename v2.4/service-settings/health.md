...
- `agents` is a map of all [Async Agents](/docs/v2.4/async/) you have running on Velonetics. The map will be empty if you don't use them. When agents are running, the value shows the time of the last working ping.
