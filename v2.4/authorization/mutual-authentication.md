...
description: The mutual TLS authentication is used in business-to-business (B2B) applications where clients must provide a certificate to connect to Velonetics
weight: 50
notoc: true
menu:
  community_v2.4:
...
Connections not having a recognized certificate in Velonetics's system CA, will be rejected. For further documentation on TLS, see the [`TLS` documentation](/docs/v2.4/service-settings/tls/)
