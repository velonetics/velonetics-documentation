...
description: 2-legged OAuth2 flow in which Velonetics negotiates a token with an authorization server to retrieve data from the backend.
weight: 50
#notoc: true
menu:
  community_v2.4:
...
Successfully setting the client credentials for a backend means that Velonetics can get the protected content. Still, the endpoint offered to the end-user will be public unless you protect it with [JWT](/docs/v2.4/authorization/jwt-overview/) or another end-user authentication mechanism.
