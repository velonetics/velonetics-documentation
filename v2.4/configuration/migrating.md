...
title: Migrating config from Velonetics 1.x or 0.x
weight: 1000
---
...
**If you have custom go plugins**, recompile them. Velonetics has now a command [`velonetics check-plugin`](/docs/v2.4/extending/check-plugin/) to test them.
