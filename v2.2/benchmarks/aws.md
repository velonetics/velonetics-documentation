...
title: Velonetics Benchmarks on AWS
description: Performance tests of Velonetics running on different Amazon Web Services instance types and final conclusions to choose the right one.
weight: 10
menu:
  community_v2.2:
