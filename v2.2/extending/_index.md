...
1. The end-user/server sends an HTTP request to Velonetics that is processed by the `router pipe`. One or more [HTTP server](/docs/v2.2/extending/http-server-plugins/) (a.k.a **http handler**) plugins can be injected in this stage.
...
## Custom middleware
The recommended way to customize Velonetics is through plugins. But as with all open-source code, you can modify Velonetics and its middleware and do your version. When writing your custom code, fork the [Velonetics-CE](https://github.com/velonetics/velonetics-ce) repository, and read "[Understanding the big picture](/docs/v2.2/design/#the-important-packages)" to identify the essential packages.
