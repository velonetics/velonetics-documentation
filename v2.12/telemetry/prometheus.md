...
To enable scrapeable Prometheus metrics on Velonetics, add the [OpenTelemetry integration](/docs/v2.12/telemetry/opentelemetry/) with a `prometheus` exporter. The following configuration is an example of how to do it:
...
When the Prometheus configuration is added into Velonetics, and your Prometheus is scrapping it, you can visualize the data using our [Grafana dashboard](/docs/v2.12/telemetry/grafana/) or make your own.
