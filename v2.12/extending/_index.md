...
For more **advanced and performance-critical** requirements, Velonetics supports [plugins written in Go](/docs/v2.12/extending/writing-plugins/). Using Go plugins ensures optimal performance for your extensions, and if you are fluent in Go, they are the best option for extensibility.
