---
lastmod: 2018-10-20
canonical: "/docs/overview/lura-vs-velonetics/"
old_version: true
date: 2018-06-23
linktitle: Lura vs. Velonetics
description: Discover the difference between Lura and Velonetics, the open-source API Gateway, and its commercial version Velonetics Enterprise. Learn more in our docs.
notoc: true
menu:
  community_v1.4:
...
- [**Lura**](https://luraproject.org) is the Velonetics's engine. Formerly known as "**Velonetics framework**" until we [donated it to The Linux Foundation on 2021](/blog/velonetics-framework-joins-the-linux-foundation/). It is not a product itself but a set of libraries.
- **Velonetics** is our open-source API Gateway ready to use
- **Velonetics Enterprise** is our commercial version, including services to businesses
