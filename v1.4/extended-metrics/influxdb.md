...
meta:
  since: v0.5
  source: https://github.com/letgoapp/velonetics-influx
  namespace:
  - github_com/letgoapp/velonetics-influx
  - github_com/velonetics/velonetics-ce-metrics
  scope:
  - service
---

Velonetics can expose detailed and extended metrics via the [velonetics-metrics](/docs/v1.4/extended-metrics/influxdb/)). The **velonetics-influx** component lets you **send these extended Velonetics metrics to InfluxDB**.

Notice that there are **two different implementations** of InfluxDB in Velonetics:
...
The **native implementation** exports data from a collector that is tailor-made for Velonetics, and also richer in content and less abstract. On the other hand, the [OpenCensus exporter for InfluxDB](/docs/v1.4/telemetry/influxdb/) is more generalistic and abstract, but implements a collector with less data. For our Grafana dahsboard, choose this one.
{{< /note >}}
...
- `db` (*string*): Name of the database, defaults to *velonetics*.
