...
In order to add metrics to your Velonetics installation add the `github_com/velonetics/velonetics-ce-metrics` namespace under `extra_config` in the root of your configuration file, e.g.:
