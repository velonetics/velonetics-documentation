...
1. **[Router layer](/docs/v1.4/endpoints/rate-limit/)**: Sets a maximum throughput to end-users hitting Velonetics endpoints.
2. **[Proxy layer](/docs/v1.4/backends/rate-limit/)**: Sets a maximum throughput between Velonetics and your backend services
