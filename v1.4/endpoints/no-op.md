...
meta:
  ...
  - endpoint
---
Velonetics `no-op` (**no-operation**), is a special type of **encoding** that behaves as a **proxy** by passing the client's request to the backend ***as is***, and vice-versa.
