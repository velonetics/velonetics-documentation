...
The client credentials **authorize Velonetics, as the client, to access the protected resources**. Do not confuse this with authorizing an end-user (see [JWT](/docs/v1.4/authorization/jwt-overview/) instead).
