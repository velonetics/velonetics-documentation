...
- `version`: The version of the Velonetics file format.
...
For instance, the [extended logging component](/docs/v1.4/logging/) uses the **namespace** `github_com/velonetics/velonetics-ce-gologging`:
{{< highlight JSON >}}
{
    "version": 2,
    "extra_config": {
