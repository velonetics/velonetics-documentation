...
<a class="btn btn-secondary btn-circle" href="https://designer.velonetics.io/">Generate configuration now</a>

## Supported file formats
Through all the documentation we refer to the configuration file as the `velonetics.json` file, but the configuration file can be written using `.json`, `.toml`, `.yaml`, `.yml`, `.properties`, `.props`, `.prop` or `.hcl`. For more information and recommendations see [supported file formats](/docs/v1.4/configuration/supported-formats/).
...
velonetics check --config ./velonetics.toml --debug
Syntax OK!
{{< /terminal >}}
...
Read more about [`velonetics check`](/docs/v1.4/commands/check/)
