...
---
Velonetics is an API Gateway with a **[zero-trust security policy](/docs/v2.5/design/zero-trust/)**, and when it comes to forward query strings, cookies, and headers, you need to define what is allowed.
...
When accessing or checking a header name through any component in Velonetics, you must write its canonical form regardless of what's being provided by the user.
...
- `Accept-Encoding`
- `Host`
- `User-Agent` (Velonetics Version 2.5)
- `X-Forwarded-For`
- `X-Forwarded-Host`
