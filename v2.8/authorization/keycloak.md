...
[Keycloak](https://www.keycloak.org/) is an Open Source **Identity and Access Management** project, sponsored by RedHat. The Velonetics configuration for Keycloak relies internally on the [JWT validation](/docs/v2.8/authorization/jwt-validation/) component.
...
![Velonetics-Keycloak validation](/images/documentation/keycloak/velonetics-keycloak-integration-workflow.png)
