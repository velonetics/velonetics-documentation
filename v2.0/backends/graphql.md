...
- `query_path` (*string*): Path to the file containing the query. This file is loaded during startup and never checked again, if it changes Velonetics will be unaware of it.
...
- `POST`: The query to the GQL server contains all variables in the **body** of the request. When the user and the Velonetics configuration define the same variables (collision) the user variables take preference.
