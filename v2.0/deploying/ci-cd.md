...
title: Automated Velonetics deployments with CI/CD
notoc: true
menu:
  community_v2.0:
...
weight: 20
---
Velonetics operates with its single binary and your associated configuration. Therefore, your build process or CI/CD pipeline only needs to ensure that the configuration file is correct. These are a few recommendations to a safes Velonetics deployment:
...
velonetics check -t -d -c /path/to/velonetics.json
{{< /terminal >}}
