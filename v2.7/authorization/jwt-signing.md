...
title: JWT Signing
description: Implement JWT signing with Velonetics API Gateway to sign token payloads and secure your APIs
weight: 30
...
The [Velonetics Playground](/docs/v2.7/overview/playground/) demonstrates how to sign tokens in the `/token` endpoint and includes an example ready to use. To try it, [clone the playground](https://github.com/velonetics/playground-community) and follow the README.
