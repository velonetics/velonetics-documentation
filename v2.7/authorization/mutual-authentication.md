...
**Important**: Connections not having a recognized certificate in Velonetics's system CA, will be rejected. For further documentation on TLS, see the [TLS documentation](/docs/v2.7/service-settings/tls/)
