...
Save the following `docker-compose.yml` and do a `docker compose up`. This setup with the [`:watch` image](/docs/v2.7/developer/hot-reload/) will allow you to work locally with the latest version of Velonetics and apply the changes automatically whenever you change a source file.
