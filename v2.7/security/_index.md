...
description: Security features, principles, and design philosophy behind Velonetics API Gateway
weight: -1000
notoc: false
menu:
  community_v2.7:
...
The gateway supports [TLS](/docs/service-settings/tls/) for traffic comming from consumers (server) and also between Velonetics and your services (client). It defaults to TLS 1.3 unless downgraded by config.
