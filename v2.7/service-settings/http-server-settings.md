...
{{< schema version="v2.7" data="velonetics.json" filter="port,cache_ttl,sequential_start,read_timeout,read_header_timeout,write_timeout,idle_timeout,use_h2c,listen_ip,max_header_bytes">}}
...
All the environment variables have the same name are the same settings above in uppercase and with the `VELONETICS_` preffix. For instance, looking at the list of settings above, you could override:
