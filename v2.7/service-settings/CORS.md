...
description: Configure Cross-Origin Resource Sharing (CORS) in Velonetics API Gateway to enable secure communication between different domains and APIs.
weight: 20
notoc: true
meta:
  since: v0.6
...
menu:
  community_v2.7:
    parent: "070 Security"
---
When Velonetics endpoints are consumed from a browser, you should enable the **Cross-Origin Resource Sharing (CORS)** module, as browsers restrict cross-origin HTTP requests initiated from scripts.
...
When working in a SPA, you will usually receive `OPTIONS` calls to Velonetics; although this configuration is not related to CORS, it usually goes in hand.
