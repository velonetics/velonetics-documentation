...
Our approach to rate-limiting has many variants:
  ...
  - [Proxy Rate Limiting](/docs/v2.11/backends/rate-limit/): Sets the maximum throughput Velonetics can have between an endpoint and your backend services (stateless).
