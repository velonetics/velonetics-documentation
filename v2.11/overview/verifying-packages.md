...
## PGP
We will check the detached signature [PGP]({{< product download_repo >}}/bin/velonetics_2.11_amd64_generic-linux.tar.gz.asc) against our package [Velonetics]({{< product download_repo >}}/bin/velonetics_2.11_amd64_generic-linux.tar.gz).

{{< terminal title="Term" >}}
gpg --verify velonetics_2.11_amd64_generic-linux.tar.gz.asc velonetics_2.11_amd64_generic-linux.tar.gz
...
To make sure the binary downloaded matches our SHA256 ensure the next 2 commands produce the same [SHA]({{< product download_repo >}}/bin/velonetics_2.11_amd64_generic-linux.tar.gz.sha256) output.

{{< terminal title="Term" >}}
shasum -a 256 -b velonetics_2.11_amd64_generic-linux.tar.gz
{{< /terminal >}}

Compare it to:
{{< terminal title="Term" >}}
curl {{< product download_repo >}}/bin/velonetics_2.11_amd64_generic-linux.tar.gz.sha256
{{< /terminal >}}