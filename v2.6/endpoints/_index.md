...
If you are still getting familiar with Velonetics's configuration structure, take a moment to read [Understanding the configuration file](/docs/v2.6/configuration/structure/).
{{< /note >}}
