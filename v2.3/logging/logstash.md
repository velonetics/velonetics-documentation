...
menu:
  community_v2.3:
    parent: "090 Logging"
---
The [Logstash](https://www.elastic.co/es/logstash/) integration prints **Velonetics application logs in JSON format** (not access logs) to ingest them and process them later. If you want to log using the Logstash standard via stdout, you need to add the `telemetry/logging` integration as a dependency.
