...
---
Velonetics is an API Gateway with a **[zero-trust security policy](/docs/v2.3/design/zero-trust/)**, and when it comes to forward query strings, cookies, and headers, you need to define what is allowed.
...
Velonetics will act as an independent client connecting to your backends and will send these headers with its own values:

- `Accept-Encoding`
- `Host`
- `User-Agent` (Velonetics Version 2.3)
- `X-Forwarded-For`
- `X-Forwarded-Host`
