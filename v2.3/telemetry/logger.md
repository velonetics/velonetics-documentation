...
meta:
  ...
  - "[SERVICE: Opencensus]"
---
Opencensus can export data to the system logger as another exporter. This **is not** the [standard Velonetics Logging](/docs/v2.3/logging/), and you should not enable both.
