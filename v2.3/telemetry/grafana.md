...
|----------|-----------|----------|----------|
| InfluxDB v2.x | Latest. Uses Flux queries | `17074` | [for-influxdb-v2.json](https://github.com/velonetics/telemetry-dashboards/blob/main/grafana/velonetics/for-influxdb-v2.json)|
| InfluxDB v1.x | Uses InfluxQL queries | `15029` | [for-influxdb-v1.json](https://github.com/velonetics/telemetry-dashboards/blob/main/grafana/velonetics/for-influxdb-v1.json)|
...
Grafana does not require any specific configuration on Velonetics, but its data source does.

For the data sources listed above, you will need to add the [InfluxDb exporter](/docs/v2.3/telemetry/influxdb/)into your `velonetics.json`, which is a configuration like this:
