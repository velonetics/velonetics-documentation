...
For the data sources listed above, you will need to add the [InfluxDb exporter](/docs/v2.1/telemetry/influxdb/)into your `velonetics.json`, which is a configuration like this:
