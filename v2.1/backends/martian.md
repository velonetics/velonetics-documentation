...
meta:
  ...
  - backend
---
The [velonetics-martian](https://github.com/velonetics/velonetics-martian) component allows you to **transform requests and responses** through a simple DSL definition in the configuration file. Martian works perfectly in combination with [CEL verifications](/docs/v2.1/endpoints/common-expression-language-cel/).
...
When **client headers** are needed, remember to add them under [`input_headers`](/docs/v2.1/endpoints/parameter-forwarding/#headers-forwarding) as Velonetics does not forward headers to the backends unless declared in the list.
{{< /note >}}
