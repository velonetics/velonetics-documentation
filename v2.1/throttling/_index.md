...
- **Rate-limiting**:
  - [Service Rate Limiting {{< badge >}}Enterprise{{< /badge >}}](/docs/enterprise/v2.1/service-settings/service-rate-limit/): Sets the maximum throughput users can have to Velonetics.
  ...
  - [Proxy Rate Limiting](/docs/v2.1/backends/rate-limit/): Sets the maximum throughput Velonetics can have against your backend services
