...
Successfully setting the client credentials for a backend means that Velonetics can get the protected content. Still, the endpoint offered to the end-user will be public unless you protect it with [JWT](/docs/v2.1/authorization/jwt-overview/) or another end-user authentication mechanism.
