...
The [Velonetics Playground](/docs/v2.1/overview/playground/) demonstrates how to sign tokens in the `/token` endpoint and includes an example ready to use. To try it, [clone the playground](https://github.com/velonetics/playground-community) and follow the README.
