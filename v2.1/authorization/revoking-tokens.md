...
**When using the Enterprise edition** the [Revoke Server](/docs/enterprise/v2.1/authentication/revoke-server/) connects to all Velonetics instances as a client, and there's nothing you need to build to make it work.
