...
[Descope](https://www.descope.com/) is a passwordless authentication and user management service designed for developers. Velonetics integrates with Descope via the [JWT validation](/docs/v2.10/authorization/jwt-validation/) component.
...
docker run --rm -v "$PWD:/etc/velonetics" -p "8080:8080" {{< product image >}}:2.10
{{< /terminal >}}
...
For more details, see [Velonetics's JWT Validation documentation](/docs/v2.10/authorization/jwt-validation/).
