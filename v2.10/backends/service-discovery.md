...
Velonetics must be in a network that can reach any declared hosts. With more than one host, Velonetics [load balances](/docs/v2.10/throttling/load-balancing/) the connections to the hosts in the list.
